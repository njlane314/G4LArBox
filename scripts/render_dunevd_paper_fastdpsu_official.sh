...
patched_gdml_rel="${PATCHED_GDML:-gdml/dunevd10kt_3view_30deg_v7_refactored_2x8x40_nowires_fastdpsu_paper.gdml}"
out_prefix="${OUTPUT_PREFIX:-data/dunevd_paper_fastdpsu_renders/dunevd_paper_fastdpsu}"
...
mkdir -p "$repo_root/gdml" "$repo_root/data/dunevd_paper_fastdpsu_renders"
...
python3 "$repo_root/scripts/crop_png_to_content.py" "$repo_root"/data/dunevd_paper_fastdpsu_renders/*.png
