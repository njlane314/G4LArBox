...
namespace G4LArBox
{
    G4VPhysicalVolume* DetectorConstruction::Construct()
    {
        ...
        G4Box* box = new G4Box("LArBox", wbox/2, hbox/2, blox/2);
        G4LogicalVolume* box_logical = new G4LogicalVolume(box, box_material, "lArBox");
        G4VPhysicalVolume* box_physical = new G4PVPlacement(nullptr, G4ThreeVector(), box_logical, "lArBox.physical", nullptr, false, 0);
